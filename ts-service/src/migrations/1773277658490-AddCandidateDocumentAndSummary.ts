...
export class AddCandidateDocumentAndSummary1773277658490 implements MigrationInterface {
    name = 'AddCandidateDocumentAndSummary1773277658490'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "candidate_documents" ("id" character varying(64) NOT NULL, "candidate_id" character varying(64) NOT NULL, "workspace_id" character varying(64) NOT NULL, "document_type" character varying(100) NOT NULL, "file_name" character varying(255) NOT NULL, "storage_key" character varying(255) NOT NULL, "raw_text" text NOT NULL, "uploaded_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a7b7572a2c5c1320a4249ce2b4c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "candidate_summaries" ("id" character varying(64) NOT NULL, "candidate_id" character varying(64) NOT NULL, "workspace_id" character varying(64) NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'pending', "score" integer, "strengths" text, "concerns" text, "summary" text, "recommended_decision" character varying(50), "provider" character varying(100), "prompt_version" character varying(50), "error_message" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_71af82300df454f7e82c777952e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "candidate_documents" ADD CONSTRAINT "FK_26407957f545234cb54af68a8e6" FOREIGN KEY ("workspace_id") REFERENCES "sample_workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "candidate_summaries" ADD CONSTRAINT "FK_d64ca49b0a8460aaf85aa5a5871" FOREIGN KEY ("workspace_id") REFERENCES "sample_workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "candidate_summaries" DROP CONSTRAINT "FK_d64ca49b0a8460aaf85aa5a5871"`);
        await queryRunner.query(`ALTER TABLE "candidate_summaries" DROP CONSTRAINT "FK_b033f7e869dac60987c01f8df7a"`);
        await queryRunner.query(`ALTER TABLE "candidate_documents" DROP CONSTRAINT "FK_26407957f545234cb54af68a8e6"`);
